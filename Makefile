...
blog: s4/s4.md
	pandoc s4/s4.md  --katex=/usr/local/lib/node_modules/katex/dist/ --output=docs/index.html --to=html5 --css=docs/tufte.css --highlight-style=pygments --self-contained --metadata pagetitle="The Annotated S4"
